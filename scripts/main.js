...
function servicioSeleccionado(e) {
    ...
    etiquetaSubTotal.innerHTML = `Mano de obra: ${formatearMoneda.format(precio)}`
    ...
    costo.classList.add("text-center", "text-success", "fw-bold", "form-control", "h-100", "wow", "fadeIn")
    costo.innerHTML = `Total: ${formatearMoneda.format(precio + (precio * 0.19))}`

    let ivaCosto = document.createElement("p")
    ivaCosto.classList.add("text-center", "text-success", "fw-bold", "form-control", "h-100", "wow", "fadeIn")
...
const reparacion = () => {
    ...
    listaDeRepuestos.forEach((repuesto) => {
        ...
        container.classList.add("card", "col-6", "col-md-6", "col-xl-3", "wow", "fadeIn")
        //Body
...
function renderCarrito() {
    ...
    sinRepetir.forEach((idRepuesto) => {
        ...
        linea.classList.add("list-group-item", "d-flex", "justify-content-between", "align-items-center", "wow", "fadeIn")
        ...
        ivaValue.classList.add("text-center", "text-success", "fw-bold", "form-control", "h-100", "wow", "fadeIn")
...
function eliminarRepuesto(e) {
    ...
    if (carrito.length === 0) {
        ivaValue.classList.remove("text-center", "text-success", "fw-bold", "form-control", "h-100")
        totalValue.classList.remove("text-center", "text-success", "fw-bold", "form-control", "h-100")
