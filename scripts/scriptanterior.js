const Servicio = (tipoServicio, precio) => {
...
const Repuestos = (id, nombre, precio, stock) => {
  this.id = id;
  this.nombre = nombre;
  this.precio = precio;
  this.stock = stock;
...
/** inicio */
alert("Bienvenido a MN FOTO - Centro de Servicio Autorizado Nikon \n Nuestros servicions \n 1. Diagnostico de equipos \n 2. Mantenimiento general \n 3. Reparación según falla")
    ...
    case "reparacion":
      ...
      switch (referenciaRepuesto) {
        case "1":
          ...
          alert(
            `El valor de la reparación con cambio de ${sensorImagen.nombre
        ...
        case "2":
          ...
          alert(
            `El valor de la reparación con cambio de ${tPrincipal.nombre
            } es de: ${formatearMoneda.format(total)}`
          );
          break;
        case "3":
          ...
          alert(
            `El valor de la reparación con cambio de ${obturador.nombre
            } es de: ${formatearMoneda.format(total)}`
          );
          break;
        case "4":
